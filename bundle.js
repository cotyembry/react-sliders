...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Handle = __webpack_require__(168);
	...
	_reactDom2.default.render(_react2.default.createElement(_Slider2.default, { div1color: 'blue', div2color: 'green', div3color: 'yellow', div4color: 'red', div1zindex: '4', div2zindex: '3', div3zindex: '2', div4zindex: '1' }), document.getElementById('Slider'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Handle = _react2.default.createClass({
		...
		checkMovement: function checkMovement(event) {
		...
		render: function render() {
			...
			return _react2.default.createElement('div', { id: "handle" + this.props._id, ref: function ref(c) {
					return _this.handleElement = c;
				}, className: 'handleClass', onMouseDown: this.mouseDown, onMouseUp: this.mouseUp, onMouseMove: this.mouseMove, onMouseOut: this.mouseOut, onMouseIn: this.mouseIn, style: { 'width': '10px', 'height': '10px', 'background': 'grey', 'position': 'absolute', 'draggable': 'false', 'borderRadius': '2.5px', 'zIndex': '10', 'left': this.state.left } });
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slider = _react2.default.createClass({
		...
		handle1ElementIncrease: function handle1ElementIncrease() {},
		handle2ElementIncrease: function handle2ElementIncrease() {},
		handle3ElementIncrease: function handle3ElementIncrease() {},
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('div', { id: 'div1', style: { 'height': '10px', 'width': this.state.div1width, 'background': this.props.div1color, 'zIndex': this.props.div1zindex, 'position': 'absolute' } }),
				_react2.default.createElement(_Handle2.default, { _id: '1' }),
				_react2.default.createElement('div', { id: 'div2', style: { 'height': '10px', 'width': this.state.div2width, 'background': this.props.div2color, 'zIndex': this.props.div2zindex, 'position': 'absolute' } }),
				_react2.default.createElement(_Handle2.default, { _id: '2' }),
				_react2.default.createElement('div', { id: 'div3', style: { 'height': '10px', 'width': this.state.div3width, 'background': this.props.div3color, 'zIndex': this.props.div3zindex, 'position': 'absolute' } }),
				_react2.default.createElement(_Handle2.default, { _id: '3' }),
				_react2.default.createElement('div', { id: 'div4', style: { 'height': '10px', 'width': this.state.div4width, 'background': this.props.div4color, 'zIndex': this.props.div4zindex, 'position': 'absolute' } })
			);
		}
	});
